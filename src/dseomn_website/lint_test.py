...
@pytest.mark.parametrize(
    ...
    (
        ...
        ('<h1 class="h1"></h1><h2>foo</h2>', r"does not have a heading class"),
        (
            '<h1 class="h1"></h1><h2 class="h2"></h2><h3>foo</h3>',
        ...
        ("<p></p>", r"exactly one h1"),
        ('<h1 class="h1"></h1><h1 class="h1"></h1>', r"exactly one h1"),
        (
            '<h1 class="h1"></h1>'
...
@pytest.mark.parametrize(
    "html",
    (
        '<h1 class="h1"></h1><h2 class="h1">foo</h2>',
        "".join(
            (
                '<h1 class="h1"></h1>',
                '<h2 class="h2"></h2>',
